...
import { createUserWithEmailAndPassword, handleGoogleSignIn, initializeFirebase, signInWithEmailAndPassword } from './firebaseAuth';
          ...
          <Card>
            <Card.Body>
              ...
              <Form autoComplete="off" onSubmit={submitHandler}>
                ...
                {newUser && (
                  <DataInput value={confirmPassword}
                    onChangeHandler={onChangeHandler}
                    type="password"
